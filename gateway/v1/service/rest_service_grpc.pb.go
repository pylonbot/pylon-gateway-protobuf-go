...
func RegisterGatewayRestServer(s grpc.ServiceRegistrar, srv GatewayRestServer) {
	s.RegisterService(&GatewayRest_ServiceDesc, srv)
}
...
// GatewayRest_ServiceDesc is the grpc.ServiceDesc for GatewayRest service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var GatewayRest_ServiceDesc = grpc.ServiceDesc{
